...
export class LiveEditorTab extends Tab {
    ...
    constructor() {
        ...
        this.app = new PIXI.Application({ width: CARD_MAX_WIDTH, height: CARD_MAX_HEIGHT, antialias: true, backgroundAlpha: 0 });
    ...
    private checkIfImageLoaded(row: IRowData, card: Card, key: string): void {
        // const resource = PIXI.Loader.shared.resources[(card as any)[key]];
